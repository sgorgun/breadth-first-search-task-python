...
def calculate_all_distances_from_vertex(n: int, edges: Dict[int, Set], vertex: int) -> List:
    ...
    E.g. you have graph with 4 vertices from 0 to 3 and edges {{0,1}, {1,2}). Starting vertex is 2,
    ...
    Returns:
        List: distance list which reflects distance between starting vertex and all other vertices,
